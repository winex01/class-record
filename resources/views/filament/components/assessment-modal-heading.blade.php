@if($record)
    <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; justify-content: space-between;">
        ...
        <div class="flex items-center gap-2">
            ...
            <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Assessment Type</p>
                <p class="text-xs font-semibold text-gray-900 dark:text-white">
                    {{ $record->assessmentType?->name ?? 'N/A' }}
                </p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <div>
                <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Max Score</p>
                <p class="text-xs font-semibold text-gray-900 dark:text-white">
                    {{ $record->max_score ?? 'N/A' }}
                </p>
            </div>
        </div>
